import cameraProject_1 from './camera-project.js';
...
function createPickRay(origin, direction, point, viewport, invProjView) {
  set_1(origin, point[0], point[1], 0);
  set_1(direction, point[0], point[1], 1);
...
var cameraBase = function cameraBase (opt) {
  ...
  function identity () {
    set_1(camera.position, 0, 0, 0);
    set_1(camera.direction, 0, 0, -1);
    set_1(camera.up, 0, 1, 0);
